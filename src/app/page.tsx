            ...
            <div className="mt-16 pt-12 border-t border-border/50">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-muted-foreground mt-1.5 max-w-lg mx-auto">
                  See what a complete HypeTest research report looks like. This is a real
                  report generated by HypeTest for a CPG energy product.
                </p>
              </div>
              ...
              <div className="bg-card rounded-2xl border border-border p-6 sm:p-8 max-w-3xl mx-auto">
                ...
                <div className="bg-muted/50 rounded-lg p-3 mb-6">
                  <p className="text-sm text-foreground italic">
                    &ldquo;The 5-minute brew time is a game-changer for my morning commute.
                    However, I&apos;d want to see real taste tests before committing.&rdquo;
                  </p>
