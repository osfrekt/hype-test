...
const SAMPLE_RESULT: ResearchResult = {
  ...
  usageOccasions: [
    { occasion: "Before or during gaming sessions", count: 14 },
    { occasion: "Morning energy boost for work", count: 12 },
    { occasion: "Pre-workout or gym sessions", count: 9 },
    { occasion: "Afternoon focus for studying", count: 8 },
    { occasion: "Late night work or content creation", count: 5 },
  ],
  purchaseBarriers: [
    "Uncertain whether powder tastes good compared to canned drinks",
    "Not convinced nootropic ingredients have real cognitive effects",
    "Would need to see third-party lab testing results",
    "Already locked into a subscription with another energy brand",
    "Concerned about caffeine dependency with daily use",
  ],
  improvements: [
    "Offer single-serve sample packs before committing to a full tub",
    "Add more flavor options beyond Blue Raspberry and Cherry",
    "Include clinical study references for the nootropic ingredients",
    "Create a caffeine-free version for evening focus",
    "Partner with gaming streamers for authentic endorsements",
  ],
  priceSensitivity: {
    buyAtLow: 38,
    buyAtMid: 32,
  ...
  personaDeepDives: [
    {
      label: "24yo male, $45k income",
      intent: 5,
      priceChoice: "Low ($25)",
      concern: "Not sure if the nootropics actually work",
      positive: "The gaming angle and clean caffeine really appeal to me",
      occasion: "During competitive gaming sessions",
      type: "enthusiast",
    },
    {
      label: "42yo female, $110k income",
      intent: 2,
      priceChoice: "Would not buy",
      concern: "I don't trust energy products marketed to gamers",
      positive: "The L-Theanine is a good ingredient choice",
      occasion: "Would not use regularly",
      type: "skeptic",
    },
    {
      label: "29yo male, $70k income",
      intent: 3,
      priceChoice: "Mid ($30)",
      concern: "Hard to justify when I already buy Celsius",
      positive: "The focus angle is interesting, Celsius doesn't have that",
      occasion: "Probably for long work-from-home days",
      type: "on_the_fence",
    },
  ],
  categoryBenchmark: {
