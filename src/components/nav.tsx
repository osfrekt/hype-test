      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border/50 bg-card">
          <div className="max-w-6xl mx-auto px-6 py-4 space-y-1">
            <p className="px-3 pt-2 pb-1 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Free</p>
            <Link href="/research/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-foreground font-medium">Consumer Research <span className="text-[10px] bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-1.5 py-0.5 rounded-full font-medium">Free</span></Link>
            <p className="px-3 pt-3 pb-1 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Starter</p>
            <Link href="/ab-test/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-muted-foreground">A/B Concept Testing <span className="text-[10px] bg-teal/10 text-teal-dark dark:text-teal px-1.5 py-0.5 rounded-full font-medium">Starter</span></Link>
            <Link href="/name-test/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-muted-foreground">Name Testing <span className="text-[10px] bg-teal/10 text-teal-dark dark:text-teal px-1.5 py-0.5 rounded-full font-medium">Starter</span></Link>
            <Link href="/pricing-test/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-muted-foreground">Pricing Optimizer <span className="text-[10px] bg-teal/10 text-teal-dark dark:text-teal px-1.5 py-0.5 rounded-full font-medium">Starter</span></Link>
            <p className="px-3 pt-3 pb-1 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Pro</p>
            <Link href="/market-research/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-muted-foreground">Market Research <span className="text-[10px] bg-primary text-primary-foreground px-1.5 py-0.5 rounded-full font-medium">Pro</span></Link>
            <Link href="/ad-test/new" onClick={() => setMobileOpen(false)} className="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm hover:bg-muted transition-colors text-muted-foreground">Ad Testing <span className="text-[10px] bg-primary text-primary-foreground px-1.5 py-0.5 rounded-full font-medium">Pro</span></Link>
